        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li>
            <?php @$page = $_GET['page']; ?>
              ...
              <li <?php if ($page == "pasien") { ?> class = "active" <?php }  ?>><a href="?page=pasien">Daftar Pasien</a></li>
              <li class = "active" ><a href="?page=pasien_tambah">Pasien Baru</a></li>
              <li <?php if ($page == "pendaftaran") { ?> class = "active" <?php }  ?>><a href="?page=pendaftaran">Pendaftar</a></li>
