...
include 'koneksi.php';
$ID = $_GET['id'];
$dua 		=		 mysqli_real_escape_string($koneksi,@$_POST['kode_obat']);
...
{
  $query = mysqli_query($koneksi,"INSERT INTO `tb_rekam_medis_obat` (kode_pemeriksaan_obat,kode_obat) VALUES ('$ID', '$dua');") or die (mysql_error());
